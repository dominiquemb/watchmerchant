...
# ----------
webhook_url="https://hooks.slack.com/services/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"       # Incoming Webhooks integration URL
...
username="Sir Deployalot, the Brave"  # Default username to post messages.
icon="man_dancing"         # Default emoji to post messages. Don't wrap it with ':'. See http://www.emoji-cheat-sheet.com; can be a url too.
